                                ...
                                <div class="card p-4 rounded-plus bg-faded">
                                    ...
                                    <form id="js-login" novalidate="" action="/register" method="POST">
                                        <div class="form-group">
                                            ...
                                            <input name="username" type="text" id="emailverify" class="form-control" placeholder="Имя пользователя" required>
                                        ...
                                        <div class="form-group">
                                            <label class="form-label" for="userpassword">Подтвердите пароль <br></label>
                                            <input name="password_confirmation" type="password" id="userpassword" class="form-control" placeholder="" required>
                                            <div class="invalid-feedback">Заполните поле.</div>
                                        </div>
